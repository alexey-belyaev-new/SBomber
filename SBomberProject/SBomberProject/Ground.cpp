...
void Crater::Draw() const
{
    ...
    {
        ScreenSingleton::getInstance().ScreenSingleton::getInstance().GotoXY(x - 4, y + 1);
        cout << "==     ==";
        ScreenSingleton::getInstance().ScreenSingleton::getInstance().GotoXY(x - 2, y + 2);
        cout << "=====";
    }
}
...
void Ground::Draw() const
{
    ...
    else
    {
        ...
        ScreenSingleton::getInstance().ScreenSingleton::getInstance().GotoXY((double)X, y);
        buf[bufSize-1] = '\0';
        cout << buf;
