...
namespace MyTools {
    ...
    void __fastcall ScreenSingleton::OpenLogFile(const string& FN)
    {
        logOut.open(FN, ios_base::out);
    }

    void ScreenSingleton::CloseLogFile()
    {
        if (logOut.is_open())
        {
            logOut.close();
    ...
    void __fastcall ScreenSingleton::WriteToLog(const string& str)
    {
        if (logOut.is_open())
        {
    ...
    void __fastcall ScreenSingleton::WriteToLog(const string& str, int n)
    {
        if (logOut.is_open())
        {
    ...
    void __fastcall ScreenSingleton::WriteToLog(const string& str, double d)
    {
        if (logOut.is_open())
        {
    ...
    //=============================================================================================
    void __fastcall ProxyFile::WriteToLog(const string& str) 
    {       
        if (logOut.is_open())
        {
            file->WriteToLog(str);
    ...
    void __fastcall ProxyFile::WriteToLog(const string& str, int n)
    {
        if (logOut.is_open())
        {
    ...
    void __fastcall ProxyFile::WriteToLog(const string& str, double d)
    {        
        if (logOut.is_open())
        {
