...
SBomber::SBomber()
    ...
    score(0)
{
    ScreenSingleton::getInstance().WriteToLog(string(__FUNCTION__) + " was invoked");
...
void SBomber::ProcessKBHit()
{
    ...
    ScreenSingleton::getInstance().WriteToLog(string(__FUNCTION__) + " was invoked. key = ", c);
...
void SBomber::TimeFinish()
{
    ...
    ScreenSingleton::getInstance().WriteToLog(string(__FUNCTION__) + " deltaTime = ", (int)deltaTime);
}
